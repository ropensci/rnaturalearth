...
require(sp)
plot(world_countries(country = 'united kingdom', classification='countries'))
plot(world_countries(country = 'united kingdom', classification='map_units'))
plot(world_countries(country = 'united kingdom', classification='sovereignty'))
...
plot(world_countries(country = 'france', classification='map_units'))
#aha need to filter by geounit to exclude (but doesn't work for classification='countries')
plot(world_countries(geounit = 'france', classification='map_units'))
plot(world_countries(country = 'france', classification='sovereignty'))
