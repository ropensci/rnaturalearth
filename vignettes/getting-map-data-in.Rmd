...
[rnaturalearth](https://github.com/AndySouth/rnaturalearth) will contain a selection of Natural Earth vector map data most useful for producing maps of the world in R. It will also have functions to facilitate accessing other vector data from Natural Earth.
...
Initially using 110 and 50 in variable names to avoid confusion.
