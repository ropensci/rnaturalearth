...
#' world country polygons from Natural Earth at 1:10m (large) resolution
#'
#' boundaries of world countries and associated attribute data
#'
#' @slot data A data frame with country attributes 
#'
#' @format A \code{SpatialPolygonsDataFrame} with 255 elements
#' @docType data
#' @keywords dataset
#' @source \url{http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_countries.zip}
#'
#' @usage data(countries10)
"countries10"
...
#' world map_unit polygons from Natural Earth at 1:50m (medium) resolution
#'
#' there are more map_units than countries e.g. French Guiana is separate from France
#'
#' @slot data A data frame with attributes 
#'
#' @format A \code{SpatialPolygonsDataFrame} with 264 elements
#' @docType data
#' @keywords dataset
#' @source \url{http//www.naturalearthdata.com/download/50m/cultural/ne_50m_admin_0_map_units.zip}
#'
#' @usage data(map_units50)
"map_units50"

#' world map_unit polygons from Natural Earth at 1:10m (large) resolution
#'
#' there are more map_units than countries e.g. French Guiana is separate from France
#'
#' @slot data A data frame with attributes 
#'
#' @format A \code{SpatialPolygonsDataFrame} with 295 elements
#' @docType data
#' @keywords dataset
#' @source \url{http//www.naturalearthdata.com/download/10m/cultural/ne_10m_admin_0_map_units.zip}
#'
#' @usage data(map_units10)
"map_units10"
